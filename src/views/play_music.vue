<template>
  <div class="body">
    ...
    <div class="Player">
      <div class="icons">
        <van-icon class="van-icon" name="play-circle-o" size="8vw"  @click="pause" v-if="animation_play_state_flag===false"/>
        <van-icon name="pause-circle-o" size="8vw" @click="pause"  v-if="animation_play_state_flag===true"/>
      </div>
      <div class="progress">
